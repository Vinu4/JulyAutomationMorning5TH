...
public static WebDriver O=null;
	 ...
	 static void  modifier()
	{
		try
		{
			...
			Thread.sleep(4000);
			O.findElement(By.xpath("//*[@*='username']")).click();
			O.findElement(By.xpath("//*[@*='username']")).clear();
			O.findElement(By.xpath("//*[@*='username']")).sendKeys("Vinu04");
			O.findElement(By.xpath("//div[@id='userDataLightBox_commitBtn']")).click();
			Thread.sleep(4000);
